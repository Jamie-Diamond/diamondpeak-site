#!/bin/bash
# Weekly summary — W8. Runs via launchd at 18:00 every Sunday.
...
/Users/diamondpeakconsulting/.local/bin/claude -p "$PROMPT" --allowedTools "$TOOLS" 2>>"$HOME/Library/Logs/ClaudeCoach/weekly-summary.log"
