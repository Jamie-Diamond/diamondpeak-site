...
- **Sat 27 Jun — Z2 ride 2h (COMPLETED, debriefed):** NP 219W · IF 0.74 · 690m gain · ~105 TSS. 65% Z1–Z2. Final climb isolated via altitude stream (km 30.9→36.8, +250m, 5.9% steep): 264W avg / 271W on steep = 89–91% FTP, HR 152→173 — Z3/sweetspot finish, NOT upper Z2 as initially called (laps 7–8 were 5km auto-splits, not the climb). Power discipline good; cardiac drift heat-driven (ERA5 33.6°C). Fuel: Maurten 320 + SiS chew + PH1500, 1.3L (~64g/hr, 660ml/hr). Strava clean. RPE not provided.
- **Fri 26 Jun — Long ride 4h Z2 (COMPLETED):** 197 TSS · NP 197W · IF 0.66 · 1,673m gain · 73% Z1–Z2. Pedalling decoupling 2.6% (whole-ride 22.1% = descent/coasting artifact — discard). ERA5 ~30°C. Fuel 277g/61g/hr · 4.05L/890ml/hr. Strava clean.
- **Thu 25 Jun PM — OW swim (COMPLETED, NOT easy — firm aerobic):** 1,202m · 25 min. 200m splits = Garmin auto-laps only, NOT athlete-marked reps. Per-lap HR peaked 147–156; session avg 129 misleads. ~22 TSS. Strava clean (original "I quit" description replaced; re-verified 27 Jun).
- **Thu 25 Jun AM — Endurance ride + climbs (COMPLETED):** 151 min · NP 206W · IF 0.69 · 119 TSS. 71% Z1–Z2. ERA5 32–35.5°C. Fuel 216g/86g/hr · ~2.5L. Strava clean.
...
- **Week Mon–Sat: ~595 TSS** (Run 49 + Swim 52 + Run 51 + Ride 119 + OWS 22 + Ride 197 + Ride ~105). Sun 28 Jun plan: long run ~15km (~85 TSS) + short OW swim (~25 TSS) → projected ~705. Above maintenance floor 608, ~47 below target 752.
- **France holiday (not camp) ends 29 Jun.** Do NOT auto-generate next week's plan — wait for Jamie to request it after returning.
- **Strava scripts (updated 26–27 Jun):** wit/humour removed per Jamie ("unprofessional"); 401 error guard added; "camp"→"holiday"; all 3 France holiday activities re-verified compliant 27 Jun.
- **⚠️ Open: Sat 27 Jun ICU calendar TSS = 184 (bogus)** — correct ~105 for 2h IF 0.74; fix before Sun readiness prompt.
