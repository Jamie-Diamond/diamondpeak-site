...
- **France camp (22–28 Jun) — Day 3 in progress:** Mon 22 easy run ✓ (49 TSS) · Tue 23 swim ✓ (52 TSS) · Wed 24 Z2 run ✓ (51 TSS) · **Thu 25 Z2 ride 2h (TODAY — 92 TSS)** · Fri 26 long ride 183 · Sat 27 Z2 ride 92 · Sun 28 long run + OW swim 120. ~642 TSS floor (heat/consecutive fatigue/OW invisible to TSS).
- **Thu 25 Jun — Z2 ride 2h (PRESCRIBED, GO):** NP 203W (IF 0.68), HR cap 140, 85g/hr carbs, 700ml/hr fluid. Route: Intersport loop 50.2km, ~900–1,000m elevation — big 360m climb at ~35km needs conservative pacing to stay Z2 in heat (~31°C). Morning ankle score not yet provided.
- **Wed 24 Jun — France Day 1 Z2 run (COMPLETED):** 8.91km, 51 TSS, GAP 5:10/km, avg HR 143 vs 150 ceiling = EASY. ERA5 30.9–32°C (RH 49%) — ERA5 confirmed heat exposure. Ankle 3/10 first half → 1–2/10 second half (within 5/10 tolerance; highest during-run score since clearance). Next time: open at 5:15–5:20 GAP.
- **Tue 23 Jun — Speed/technique swim (last pool before France OW week):** 2,000m, 52 TSS. 4×100m drill WITH paddles (catch/DPS — no speed target per rule 78); 8×100m paddle-OFF avg 1:38 vs TGT 1:36–1:38 (held to last rep, final 3 at 1:36); 2×200m PB at CSS 1:41/1:40. Next time (paddle-OFF speed set): start 1:37 reps 1–4.
- **Mon 22 Jun — Easy run (EASY + heat):** 7.62km, 49 TSS, GAP 4:53/km, avg HR 141 vs 146 ceiling = EASY. ERA5 ~28°C.
- **Ankle:** ATFL + CFL partial tear (2026-06-12 ultrasound). Latest: 3/10 peak France Day 1 run (24 Jun), settled 1–2/10 second half. Protocol: ≤5/10 during = OK if resolves by next AM; >5/10 = stop. Thu 25 Jun morning score not yet given.
- **Heat acclimation tracker DEPLOYED:** heat_accl.py (commit 47921f7, 07:08 25 Jun). Live score: **39% ↑** (5 exposures ≥28°C since 21 Jun — Sat 21 ride 28°C · Sat 21 brick 31°C · Mon 22 run 28°C · Wed 24 run 31°C + 1 more; May Marseille block largely decayed). Will appear on tomorrow's morning card.
- **CP vs FTP (confirmed 25 Jun):** eFTP 297W = working metric for IM; CP+W′ passively populated from power curve; no structured test needed; race pacing far below threshold makes the gap irrelevant.
- **Weight:** ~83 kg; race target 79 kg (19 Sep 2026); ~4 kg to lose.
- **CTL/form (25 Jun):** CTL 86, ATL 91, TSB −5. HRV trend −2.6% (latest 41 on 24 Jun). Sleep 5.05h carried. IM Italy 19 Sep 2026 (86 days).
- **Bug list (25 Jun — 13 logged; #12 DEPLOYED):** (1) Cervélo hallucination; (2) Planning algo copies ICU calendar; (3) TSS flat-rate estimation; (4) Morning cron duplicate; (5) Replan-week button too easy; (6) NOT EASY terrain-Z3 (→rule 77); (7) WU/CD drift clipping (→rule 74); (8) Bug list not maintained (meta); (9) ERA5 when watch ≥25°C (→rule 75); (10) Ambient start/mid/end long sessions (→rule 76); (11) Voice reply button; (12) Heat acclimation tracker (DEPLOYED 07:08 25 Jun); (13) Run analysis too data-heavy (→rule 81). Pending code fixes: 5, 8, 11; 6–10 corrected as rules.
