...
- **France camp — week 22–28 Jun (Day 2 completed, Day 3 prescribed):** Schedule: Mon 22 easy run 46 · Tue 23 swim 52 · Wed 24 Z2 run 51 · **Thu 25 Z2 ride 2h 92 TSS (PRESCRIBED, GO)** · Fri 26 long ride 183 · Sat 27 Z2 ride 92 · Sun 28 long run + OW swim 120. ~642 TSS floor (heat/consecutive fatigue/OW invisible to TSS). Full time available.
- **Thu 25 Jun — Z2 ride 2h (PRESCRIBED: GO):** Targets: NP 203W (IF 0.68, Z2 178–223W); HR cap 140; 60g/hr carbs; 700ml/hr fluid. Route shared: Intersport loop 50.2km, ~900–1,000m elevation — advised to ride the big climb (360m) conservatively or do first loop only (~25km) to stay Z2 in heat. Morning ankle score for 25 Jun not yet confirmed.
- **Wed 24 Jun — France camp Day 1 Z2 run (COMPLETED):** 8.91km, 51 TSS, GAP 5:10/km, avg HR 143 vs 150 ceiling = EASY. ERA5 ambient 30.9–32°C (RH 49%) — 4th 28°C+ heat exposure in 72h. Ankle 3/10 first half, settled 1–2/10 second half — within 5/10 tolerance. Next time: open at 5:15–5:20 GAP to preserve HR ceiling for back half.
- **Tue 23 Jun — Speed/technique swim (last pool before France):** 2,000m, 34:18, 52 TSS. Drill 4×100m WITH paddles (catch/strength, no pace target — rule 78); speed 8×100m paddle-OFF avg 1:38 vs TGT 1:36–1:38 (rallied 1:36 last 3); 2×200m PB at CSS 1:41/1:40. Next time (paddle-OFF speed set): go out 1:37 reps 1–4.
- **Mon 22 Jun — Easy run (EASY + heat):** 7.62km, 49 TSS, GAP 4:53/km. Avg HR 141 vs 146 ceiling = EASY. ERA5 ~28°C. Main-block drift 140→147 (~7 bpm, WU/CD clipped per rule 74).
- **Ankle:** ATFL + CFL partial tear (ultrasound 2026-06-12). Latest: 3/10 peak during France Day 1 run (24 Jun), settled 1–2/10 second half — within 5/10 tolerance; highest during-run score since clearance. Protocol: ≤5/10 during = OK if resolves by next AM; >5/10 = stop. Thu 25 Jun morning score not yet provided.
- **Heat log (active camp):** 5+ exposures ≥28°C (Sat 21 ride 28°C · Sat 21 brick 31°C · Mon 22 run 28°C · Wed 24 run 31°C). ERA5 confirmed each. Feature request: Garmin-style 0–100% heat acclimation score — logged as bug (12) for implementation.
- **CP vs FTP (confirmed 25 Jun):** eFTP 297W = working metric for IM (race IF 0.68–0.73); CP+W′ passively populated from power curve; no structured test needed; race pacing far below threshold so gap irrelevant.
- **Weight:** ~83 kg; race target 79 kg (19 Sep 2026); ~4 kg to lose.
- **CTL/form (25 Jun):** CTL 86, ATL 91, TSB −5. HRV trend −2.6% (latest 41 on 24 Jun). Sleep 5.05h carried. Build week 9. IM Italy Emilia-Romagna 19 Sep 2026 (~86 days).
- **Bug list (25 Jun — 13 open):** (1) Cervélo hallucination; (2) Planning algo copies ICU calendar; (3) TSS flat-rate estimation; (4) Morning cron duplicate; (5) Replan-week button too easy; (6) NOT EASY on terrain-Z3 (→rule 77); (7) WU/CD drift clipping (→rule 74); (8) Bug list not maintained (meta-bug); (9) ERA5 when watch ≥25°C (→rule 75); (10) Ambient start/mid/end long sessions (→rule 76); (11) Voice reply button; (12) Heat acclimation 0–100% Garmin-style tracker; (13) Run analysis too data-heavy, not enough insight (→rule 82). Code fixes for 5, 8, 11, 12, 13 pending; 6–10 corrected as rules.
