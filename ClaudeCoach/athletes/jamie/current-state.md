...
- **Fri 26 Jun — Long ride 4h Z2 (COMPLETED):** 197 Load (+8% vs 183 planned). NP 197W · IF 0.66 · 1,673m gain · 73% Z1–Z2. Whole-ride decoupling 22.1% = descent/coasting artifact (discard); pedalling-only 2.6% = clean aerobic control. ERA5 ~30°C (watch peaks ~46°C on cols). Big col efficient: 253W @ 155 HR. Fuel: 277g (61g/hr) · 4.05L (890ml/hr). Strava description updated: pedalling-only decoupling, heat noted, no plan-comparison.
- **Thu 25 Jun PM — OW swim (COMPLETED, firm aerobic — NOT easy):** 1,202m · 25 min. 200m splits = Garmin auto-distance markers, NOT marked reps (rule 84). Per-rep HR peaked 147–156 — NOT easy (rule 83). ~51 TSS.
...
- **Ankle:** ATFL + CFL partial tear (ultrasound confirmed). Latest: 3/10 peak Wed 24 Jun run, settled 1–2/10. Protocol: ≤5/10 OK if resolves by next AM; >5/10 = stop. No ankle issues reported on rides.
- **Heat acclimation:** Live 39% ↑ (heat_accl.py, confirmed 25 Jun). 5+ exposures ≥28°C since 21 Jun; Fri 26 Jun col peaks ~36–37°C ambient. Climbing fast through France holiday.
- **France holiday remaining (to 29 Jun):** Sat 27 endurance+climbs 2h IF ~0.71 (~105 TSS) · Sun 28 long run ~15km (~92 TSS) + OW swim (~25 TSS). Week-to-date ~367 TSS. Projected week ~727 TSS (genuine build vs 608 floor; heat undersells true stress). Sat confirmed endurance+climbs IF ~0.71, NOT pure Z2.
- **Strava auto-descriptions:** snide/witty tone removed from all prompt levels. 401 error guard deployed. CLI auth token may need refresh on VM for rich vs fallback descriptions.
