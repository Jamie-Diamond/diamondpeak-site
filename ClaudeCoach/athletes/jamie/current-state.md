...
- **Mon 29 Jun — OW swim (Long Swim slot):** 2,618m · 2:07/100m · HR avg 112 / max 122 (Z1) · TSS 45 vs plan 54 (−17%, 622m short). RPE not given.
- **Sun 28 Jun — Long run 15.2km (EASY):** GAP 5:16/km · avg HR 143 vs 146 Z2 ceiling · TSS ~84 · ERA5 ~32°C. Decoupling −4.6% (CV held); economy fade +6.9% final 5km = durability limiter. Ankle 0→2/10 peak, resolved. Fuel: SiS fudge bar (~25g) + PF30 chew (30g) = ~41g/hr · 675ml/hr.
- **Sun 28 Jun — Recovery OW swim post-run:** 1,031m · 1:59/100m · HR avg 125 / max 131 (Z1) · TSS 20.
- **Sat 27 Jun — Z2 ride ~2h:** NP 219W · IF 0.74 · TSS ~105 · ERA5 33.6°C. Final climb isolated 264–271W = 89–91% FTP · HR 152→173. Fuel 64g/hr · 660ml/hr.
- **Fri 26 Jun — Long Z2 ride 4h:** TSS 197 · NP 197W · IF 0.66 · 1,673m gain · ERA5 ~30°C. Pedalling-only decoupling 2.6%.
- **Week Mon 22–Sun 28 FINAL: ~699 TSS.** Floor 631 (CTL×7), target 748. ~49 short — appropriate; France holiday, consecutive hot days. Load managed to rolling average, not weekly target-chasing.
- **Ankle:** ATFL + CFL partial tear. 29 Jun: 0/10 morning, 1/10 afternoon (rest day, OW swim only). ~7 weeks to 30km run durability; zero setback margin. Next long run Thu 2 Jul (~17km, W10).
- **Heat acclimation:** 77% (ClaudeCoach model; Garmin shows 100%). France block: 6 hot sessions in 7 days (three rides 34–37°C dry). **Dose model locked 2026-06-29:** outdoor = base × temp_mult × HR-strain_mult (Karvonen HRR, ref 65%) × humidity_mult (dew-point, ref 16°C). Sauna/hot bath = flat 1.0 dose (not run through multipliers — passive heat, HR suppressed but core temp high). Indoor turbo = 0 by default (virtual flag; manually log as 1.0 if deliberately hot no-fan session). All recent sessions backfilled with HR + dew-point. France was dry heat (dew 16–16.5°C ≈ neutral) — humidity weighting matters most at humid Cervia.
- **CTL ~91 · ATL ~107 · TSB ~−16 (29 Jun).** IM Italy 81 days (19 Sep 2026).
- **Race readiness:** Bike ~90% (3.6 W/kg, pacing confirmed) · Swim ~75% (CSS 1:40/100m, OW building) · Run ~50% — ankle progression sole question mark.
- **Weight:** ~83 kg · race target 79 kg · ~4 kg to lose.
- **W10 bespoke plan (one-off — travel return from work trip):** Mon long swim 70min · Tue Z2 run 55min · Wed strength 40min · Thu long run ~17km + CSS swim 60min · Fri long Z2 ride 240min · Sat sweetspot 110min + brick 25min · Sun Z2 ride 150min + brick 25min. Target ~744 TSS. Synced to Garmin (template bug on first push — corrected).
- **Aero helmet due Tue 30 Jun — still pending.** Flag in Tue morning check-in.
- **Bug backlog (3 active):** (1) "Logged." without file write (rule 97). (2) Long-run check-in drifted above progression cap (rule 96). (3) Calendar sync pushed generic template not agreed bespoke plan (rule 98).
- **Open actions (overdue):** PH sweat-sodium test · TT bike fit · Running FTP 500W in ICU. Wed W10 strength kit not confirmed (full gym / dumbbells-KBs / bodyweight?).
