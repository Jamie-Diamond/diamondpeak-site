...
- **Thu 2 Jul — CSS Swim (COMPLETED):** 33m pool — Jamie did 8×8 lengths (bonus 2 reps vs planned 6×8). 2,904m total (88 lengths). Rep paces 1:38–1:41/100m displayed (50m-equivalent ~1:40–1:42, dead on CSS). Avg HR 127 (Z1–low-Z2). TSS 80 vs planned 58 (+38%). 3s spread across all 8 — textbook CSS repeatability. RPE still pending. Thu Z2 Ride 150min pending (not yet completed as of session end).
...
- **W10 plan (29 Jun–5 Jul, active):** Mon ✓ swim (45) · Wed ✓ run (67) · Thu ✓ swim (80) + Z2 Ride 150min pending · Fri Long Z2 Ride 5h30 · Sat Sweetspot 1h50 · Sun Long Run ~17km. Completed to date: 192 TSS. Projected ~762 vs ~806 target (−5% — managing to multi-week trend, not chasing). Three load levers on hold (Wed strength +18, Thu +30min +21, Fri +30min +22) — Jamie said "hold, see how the week goes."
- **Weight:** 85.3kg (30 Jun) vs 79kg race target (+6.3kg, 79 days out). ~1.0–1.5kg likely heat-fluid (PV expansion + glycogen water). Do not chase during heat work; judge fat trend on 7-day rolling avg in a cooler week.
- **Race readiness (79 days to IM Italy 19 Sep):** CTL 89 · ATL 95 · TSB −6. Bike ~90% · Swim ~75% · Run ~50%.
- **Bugs fixed 1 Jul:** Sleep morning-card date fixed to waking-day (was one day stale). Strava description: watch sensor temp never cited; heat line gated to ERA5-confirmed ≥25°C. Auth 401 blip → fallback to plain template confirmed working.
- **Rules confirmed 1–2 Jul:** Start-of-run HR ramp = normal physiology, never flag (104). Terrain Z3 on easy run = EASY if avg HR within ceiling (77). Non-50m pool → prescribe lengths not time, even reps so Jamie ends at bottle end (106–107). Strava heat commentary only at ERA5 ≥25°C (105). Session TSS-vs-target question during debrief = session level, not weekly (108).
