...
- Current pain 1–10 (during run): 0 flat / 1–2 uphills (Tue 9 Jun — Coventry Running 10.17 km, continuous). Previous: 2 warmup → 0 from km 2 (Sat 6 Jun — Wandsworth Running 9.57 km). Pain location: uphill/warmup = anterior impingement stimulus (dorsiflexion under load); flat = pain-free. Pattern stable for ~3 weeks.
