...
- **Sun 5 Jul AM readiness:** HRV 34 (tied lowest in 14d; range 34–50, avg ~40), RHR 57 (near top of 51–58 range, above ~54 baseline), sleep 77 (not the limiter). TSB −30.3, ATL 126.2 — still not recovered from Fri/Sat back-to-back big days. AM call: cap today's long run near 12km, hold GAP easy, don't chase splits. Injury pain score asked, not yet answered.
- **Today's long run (Sun 5 Jul):** base plan was 82min/16.9km/94 Load (event 119142487, corrected from a stale 13.5km baseline to the actual 15.2km Grimaud run ×1.10–1.15) — now further capped to ~12km per this morning's recovery signals. Running late afternoon (Jamie's choice) for max recovery buffer, a heat-accl opportunity, and a cleaner ~60g/hr run-fuelling test (rule 112) on a fed stomach — result still pending.
