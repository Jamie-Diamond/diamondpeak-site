...
- **France camp (22–28 Jun) — Day 3 in progress (Thu 25 Jun):** Mon 22 easy run ✓ (49 TSS) · Tue 23 swim ✓ (52 TSS) · Wed 24 Z2 run ✓ (51 TSS) · **Thu 25 Z2 ride 2h (TODAY — 92 TSS prescribed, not yet synced)** · Fri 26 long ride 183 · Sat 27 Z2 ride 92 · Sun 28 long run + OW swim 120. ~642 TSS floor (heat/consecutive fatigue/OW invisible to TSS).
- **Thu 25 Jun — Z2 ride 2h (PRESCRIBED, GO):** NP 203W (IF 0.68), HR cap 140, 85g/hr carbs, 700ml/hr fluid. Route: Intersport loop 50.2km, ~900–1,000m elevation — big 360m climb at ~35km needs conservative pacing to stay Z2 in heat (~31°C). Ankle score Thu AM not given.
- **Wed 24 Jun — France Day 1 Z2 run (COMPLETED):** 8.91km, 51 TSS, GAP 5:10/km, avg HR 143 vs 150 ceiling = EASY. ERA5 30.9–32°C (RH 49%). Ankle 3/10 first half → 1–2/10 second half (highest during-run score since clearance, within 5/10 tolerance). Next time: open at 5:15–5:20 GAP.
- **Tue 23 Jun — Speed/technique swim (COMPLETED, last pool before France OW week):** 2,000m, 52 TSS. 4×100m drill WITH paddles (catch/DPS — no speed target per rule 78); 8×100m paddle-OFF avg 1:38 vs TGT 1:36–1:38 (held to last rep, final 3 at 1:36); 2×200m PB at CSS 1:41/1:40. Next time (paddle-OFF speed set): start 1:37 reps 1–4.
- **Mon 22 Jun — Easy run (EASY + heat):** 7.62km, 49 TSS, GAP 4:53/km, avg HR 141 vs 146 ceiling = EASY. ERA5 ~28°C.
- **Ankle:** ATFL + CFL partial tear (2026-06-12 ultrasound). Latest: 3/10 peak during France Day 1 run (24 Jun), settled 1–2/10 second half. Protocol: ≤5/10 during = OK if resolves by next AM; >5/10 = stop. Thu 25 Jun morning score not given.
- **Heat acclimation tracker LIVE:** heat_accl.py deployed 07:08 25 Jun (commit 47921f7). Live score: **39% ↑** (5 exposures ≥28°C since 21 Jun; May Marseille block largely decayed). Morning card 25 Jun missed it (card fired ~06:30, before deploy) — shows from 26 Jun. ⚠️ ClaudeCoach error 25 Jun: estimated 65–70% instead of running the script; rule added to always run heat_accl.py when asked.
...
- **Bug list (25 Jun — 13 logged; #12 DEPLOYED):** Pending code fixes: 5 (replan guard), 8 (bug list maintenance), 11 (voice reply). Rules-corrected: 6 (terrain Z3→77), 7 (WU/CD→74), 9 (ERA5 trigger→75), 10 (start/mid/end temp→76), 13 (run insight→81), +new (heat score estimate→82). Deployed: 12 (heat tracker 07:08 25 Jun).
