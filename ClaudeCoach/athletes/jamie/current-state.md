...
- **Sat 4 Jul — Sweetspot Ride Modified 2×15 (COMPLETED):** Actual 149 Load vs 97 planned (+54%; ride ran ~210min vs 110 planned). NP 198W/IF 0.67/VI 1.41, hilly (874m gain, 29% coasting), 81% time Z1-Z2, avg HR 118. Decoupling pedalling-only −2.6% (whole-ride 11.6% is a coasting artifact). Nutrition: Maurten 320 + 2 scoops HIGH5 Caffeine Hit + 2×SiS choco fudge bar + 1 PF30 ≈200g carb over 3.5h (~57g/hr — below 75g/hr target but duration-diluted, total grams solid) + ~2.8L fluid + PH1500. RPE 4 (base), with 350–400W efforts (118–135% eFTP) at RPE 9/10 — those surges satisfy the "hard effort every 2–3wk" need, no structured intensity required soon. TSB now −35.3, ATL 131.2 — heaviest of this build block. 7 PRs. No heat dose (ERA5: ~20–25°C across the window, below the 25°C/60min gate).
- **Nutrition focus shift (confirmed 4 Jul, rule 112):** Bike carb tolerance proven (90–100g/hr demonstrated) — no need to chase 90g/hr every ride, just the odd session near target. Open question is now the RUN: can Jamie get near 60g/hr while running. Sun 5 Jul long run (16.9km/82min) is the test bed — 60g/hr ≈ 80g total (~2 gels + carb drink sips, or a gel every ~25min from the 20min mark). Log actual intake + gut response.
- **Sun 5 Jul run — timing + risk:** Jamie running late afternoon for max recovery after Sat's heavier-than-planned ride. Afternoon July heat doubles as heat-accl stimulus but adds strain on top of −35.3 TSB; hydrate well pre-run.
- **Sun 5 Jul — Long Run:** corrected to 82min/16.9km/94 Load (event 119142487, was 95min/19.5km/109). Progression basis: last week's actual long run was 15.2km (28 Jun, Grimaud, France), not the stale 13.5km baseline — 15.2×1.10–1.15 = 16.7–17.5km. Structure: 10min build-in → 67min Z2 (GAP ~4:41–4:57/km) → 5min build-down.
- **Bug fixed (4 Jul, rule 111):** long-run progression baseline used a stale "BLOCKED" status note instead of the actual synced 28 Jun run (15.2km Grimaud) — produced a wrong 19.5km target, caught by Jamie's own arithmetic check. New rule added: verify baseline against synced data, not status labels.
- **Bug fixed (4 Jul, new rule):** initial Sun-run preview gave pace/HR targets only and omitted time/distance — Jamie flagged as a bug. New rule: session previews must always state time + distance up front.
- **Fri 3 Jul — Long Z2 Ride (COMPLETED):** ON TARGET. NP 206W (IF 0.69) within 183–214W band, HR 95% Z1+Z2. Pedalling-only decoupling 4.4% (whole-ride 8.7% is a coasting artifact). Duration 284min vs 330 planned, TSS 223 vs 232 (−4%). No heat dose (ERA5 peak 20.6°C). 14 PRs. Nutrition ≈87g/hr carb, ~550ml/hr fluid; lost 1.3kg → sweat rate ~824ml/hr, ~67% replacement. RPE not given as a number — Jamie: "felt pretty dead after that/now." TSB −21.2, ATL 113.5 at the time.
- **CTL/TSB ramp formula (Fri 3 Jul):** rule of thumb TSB ≈ −5 × weekly ramp (+2/wk → −10; +4/wk, Jamie's recent ceiling → −20) — explains the −18 to −35 readings across this block.
- **Thu 2 Jul sessions (COMPLETED):** CSS Swim — 33m pool, 2,904m (8×8 lengths, bonus 2 vs planned 6), rep pace 1:38–1:41/100m on CSS, TSS 80 vs 58 (+38%), RPE 7. Z2 Ride 105min — not Z2, NP 224W/IF 0.75, TSS 97 vs 106 (−8%), no heat dose (24.4°C, just under gate).
...
- **Heat acclimation:** Score **77%** (77 days to race). No dose added from Thu/Fri/Sat rides — all below the 25°C/60min gate.
- **W10 plan (29 Jun–5 Jul):** 512 completed (through Thu) + 149 (Sat actual) + 94 (Sun planned) = 755 vs ~764 target — on track (~−1%).
- **Weight:** 85.3kg (30 Jun) vs 79kg race target (+6.3kg). Asked again Fri 3 Jul and Sat 4 Jul mornings — chart/photo sent both days but no numeric figure logged yet.
- **Open action:** Aero helmet — overdue since 30 Jun, re-flagged a third time in Sat 4 Jul AM check-in, still unconfirmed.
...
- Current pain 1–10 (during/post run): **3 (24 Jun — Grimaud Running 8.9 km, France camp day 1, ~31°C; peaked 3/10 first half, settled to 1–2/10 second half — within 5/10 tolerance)**; 2 (17 Jun — on Wed easy run 5.7 km, continuous; "it's ok"); 2 (16 Jun — after Coventry long run 13.5 km, continuous, GAP 4:46, 23–28°C); 2 uphill / 0–1 flat & elsewhere (Wed 10 Jun — Coventry Z2 Run 10.76 km, continuous). Previous: 0 flat / 1–2 uphills (Tue 9 Jun — Coventry Running 10.17 km, continuous). Pain location: uphill/warmup = anterior impingement stimulus (dorsiflexion under load); flat = pain-free. Pattern stable for ~3 weeks.
- Current pain 1–10 (resting): **1 (29 Jun PM — 0/10 in the morning, mild 1/10 by the afternoon; rest day, OW swim only, no run)**
- Current pain 1–10 (next morning): **18 Jun (qualitative) — ankle "doesn't feel as good as it normally does the day after I run"; recovery lagging vs typical, no score given. Recommended skipping today's easy run on that basis.**; 1 (17 Jun AM — settled overnight from 2/10 post long run); 0 ("ankle is fine") (16 Jun AM — day 3 of ibuprofen course); 1–2 (11 Jun AM — after Wed 10 Jun run; loosened off quickly); 0 (10 Jun AM — after Tue 9 Jun run); 0 (9 Jun AM — after Sat 6 Jun run)
- Current pain 1–10 (next morning): 0 (Fri 8 May); 0 (Sat 9 May); 0 (Sun 10 May, resting); 0 (Mon 11 May AM, resting — "ankle is good"); 0.5 (Wed 14 May AM — after Mon 11 May 7.4 km run); 0.5 (Thu 14 May AM — after Wed 13 May 11.1 km run — "ankle is good"); 0 (Sun 17 May AM — after Sat 16 May ride only, no run); 0 (Mon 18 May AM — after Sun 17 May first no-walk 5k run); **0.5 (Tue 19 May AM — after Mon 18 May 4.8 km run)**; **0.5 (Wed 20 May AM — after Tue 19 May elliptical + swim)**; **1.0 (Fri 22 May AM)**; **0 (Tue 3 Jun AM)**; **0 (Thu 4 Jun AM — after Wed 3 Jun 40 min continuous run)**
...
### Self-assessment — 2026-06-02 deep diagnostic (10-question conversation)

Self-tests and symptom mapping performed in detailed conversation, 14 weeks post-injury:
...
- Visible swelling: still present at front of joint after 14 weeks
- Pain during run: dull ache (never sharp), eases mid-run but never reaches 0
- Pain location: varies front-outside ankle or sometimes Achilles, especially warmup/uphills
- Pain timing: takes a while to come on, then warms up through the session (mostly yes, but not to zero)
...
- However: 9 min continuous may be perpetuating the effusion cycle
  - Sustained dorsiflexion under load irritates synovium repeatedly
  - Frequent load-off (shorter intervals) would reduce stimulus per session
  - 2–3 min run / 1–2 min walk allows joint to decompress more frequently
- 9:1 is a training tool (Galloway), not a clinical rehab protocol — should be validated by physio for *this* injury type before continuing

**Self-management actions while awaiting physio:**
1. *Compression sleeve* all day (snug, not restrictive) — reduces fluid pooling
2. *Elevation* 1–2x daily, 20–30 min legs above heart — gravity aids fluid reabsorption
3. *Ice after running* 10–15 min within 30 min of finishing — reduces synovial irritation
4. *Reduce plantar flexion load* — adjust car seat, take breaks on long drives
...
- **2026-06-21 GO** — Endurance ride 187 min (bike_z2) + Long run 70 min (run_long): no rules fired, execute as planned. CTL 89 (Fitness), ATL 117 (Fatigue), TSB −28 (Form) — heavily fatigued after 298 TSS across Fri/Sat. HRV trend −3.1% (latest 41 on 20 Jun; today not synced at 05:00 — trailing trend, correct); sleep 7.12h carried (20 Jun, most recent synced). Last RPE 8. Bike: NP 178–208W (60–70% eFTP 297W), HR cap 146, cadence 85–95 rpm, VI <1.08; nutrition 70–80g CHO/hr, 600–700ml/hr. Run: continuous Z2 70 min (plan label "walk-run" retired per Jun 9 rule), HR cap 146, GAP 5:00–5:30/km, stop-if ankle >5/10 in force; ankle 2/10, quality_cleared false.

- **2026-06-20 GO** — Long Z2 ride 2.5h (bike_z2): no rules fired, execute as planned. CTL 87 (Fitness), ATL 108 (Fatigue), TSB −21 (Form) — carrying fatigue after 216 TSS yesterday (27% over plan). HRV trend +7.5% (latest 45 on 19 Jun; today not synced at 05:00 — trailing trend, correct); sleep 6.05h carried (19 Jun, most recent synced). Last RPE 8. Ankle not relevant for bike. Session: TT position, NP 178–208W (60–70% eFTP 297W), HR cap 146, cadence 85–95 rpm, VI <1.08. Nutrition: 70–80g CHO/hr from 30 min, 600–700ml/hr fluid.

- **2026-06-19 GO** — Long Z2 ride 4h (bike_z2): no rules fired, execute as planned. CTL 86 (Fitness), ATL 107 (Fatigue), TSB −21 (Form) — carrying fatigue. HRV trend −0.4% (latest 42 on 18 Jun; today not synced at 05:00 — trailing trend, correct); sleep 6.45h carried (18 Jun, most recent synced). Last RPE 8. Ankle not relevant for bike. Session: TT position, NP 178–208W (60–70% eFTP 297W), HR cap 146, cadence 85–95 rpm, VI <1.08. Nutrition: 70–80g CHO/hr from 30 min, 600–700ml/hr fluid.

- **2026-06-18 GO** — CSS — 5×200m (swim) + Easy run — Z2 continuous (run_easy): no rules fired, execute both as planned. CTL 83.3 (Fitness), ATL 91.3 (Fatigue), TSB −8.0 (Form) — mildly fatigued. HRV null (not synced today); sleep null (not synced); RHR 51 (within 50–54 baseline). Last RPE 1 (ankle training 17 Jun). Swim: CSS — 5×200m, 50 min total, ~2,424m, main set @ 1:39/100m CSS, WU/CD aerobic. Run: Z2 continuous 45 min, HR cap 146, GAP ~5:00–5:30/km. Ankle: 2/10 during last run (17 Jun); 1/10 AM (17 Jun); quality_cleared still false; stop-if->5/10 in force.

- **2026-06-16 GO** — Speed swim 8×100m (swim) + Easy run 45 min (run_easy): no rules fired, execute both as planned. CTL 82.9 (Fitness), ATL 92.3 (Fatigue), TSB −9.4 (Form) — mildly fatigued, recovering from rest day Jun 15. HRV null (not synced today); sleep null (not synced); RHR 50 (within 50–54 baseline). Last RPE 5 (Jun 14 ride). Swim: 8×100m @ 1:28–1:35/100m + 6×200m @ 1:35–1:41/100m. Run: continuous Z2 (plan label says "run-walk" but walk-run format is retired — execute continuous; HR cap 146, GAP 5:00–5:30/km). Ankle: 2/10 during within physio protocol (≤5/10); stop-if->5/10 in force; quality_cleared still false.
...
- Missed sessions: Thu 18 Jun easy run 45 min (39 TSS) — CANCELLED by agreement (deleted from calendar). Reason: ankle next-morning recovery lagging vs typical + 3 days of riding cover the weekend aerobic load. Week still projects ~731 TSS (with hot 138k Friday) — genuine build week, no need to claw back. Do not reschedule. Wed 6 May easy run 5 km — moved and extended to Thu 7 May (13 km compensatory, completed); Sun 10 May brick run skipped (busy day, chose to wind down)
- Cut sessions: none
...
- **2026-05-14 — T10 (Tier 2, confirmed):** Actuals Mon 11–Thu 14 = 18.50 km (Mon 7.39 + Wed 13 May 11.11) vs 12.52 last wk = +47.8% w/w. Pre-flag breach now confirmed. Wed 13 May run HR 141, pace 5:06/km, no pain logged yet for next-morning; if Sun 17 May 5k goes ahead, week ends ~23.5 km (+88%). Decision: keep or cut Sun 5k pending Thu/Fri ankle status.
...
- **2026-05-19 — T7 (Tier 1):** Heat dose 1 session in last 14 days (last: 10 May hot bath 25 min @ 45°C) vs target ≥3. Protocol day 5 but no sessions since 05-10. Travel block extends gap — first realistic opportunity remains Marseille 24 May (hotel bath or sauna access required).
- **2026-05-19 — T8 (Tier 2):** Last heat session 2026-05-10 — now 9 days ago, exceeds 7-day decay threshold. Any adaptation from the single session has lapsed. Marseille 24–30 May is the first window to rebuild; confirm hotel has bath or sauna before departure.
- **2026-05-19 — T9 (Tier 2):** Dorney Olympic tri entry (C- race 6 Jun) due 2026-05-25 (Mon, 6 days), status TBC. Confirm entry or drop — decision cannot slip beyond Mon 25 May. Key constraint: 10k run on ankle still at 2/10 pain during runs; quality sessions not yet cleared.
- **2026-05-20 — T7 (Tier 1):** Heat dose 1 session in last 14 days (last: 10 May hot bath 25 min @ 45°C) vs target ≥3. Protocol day 6 but no sessions since 05-10. Travel block continues — first realistic window remains Marseille 24 May. Confirm hotel bath or sauna access before departure Sat 23 May.
- **2026-05-20 — T8 (Tier 2):** Last heat session 2026-05-10 — now 10 days ago, exceeds 7-day decay threshold. Any adaptation from the single session has fully lapsed. Marseille 24–30 May is the rebuild window; target 4–5 sessions in 6 days to re-establish protocol.
- **2026-05-20 — T9 (Tier 2):** Dorney Olympic tri entry (C- race 6 Jun) due 2026-05-25 (Mon, 5 days), status TBC. Decision cannot slip further. Key constraint: 10k run on ankle still at 2/10 pain; quality sessions not cleared. If entered, plan Z2 run-pace only for 10k leg.
- **2026-05-21 — T3 (Tier 1):** HRV trend -7.3% over 7 days (41 on 05-14 → 38 on 05-20). RHR elevated to 57 today (vs 50–54 baseline). Possible cold/flu onset noted 2026-05-20. Multi-signal convergence (HRV + RHR + possible illness) — monitor; if illness confirmed, treat tomorrow's swim as TBC and hold load.
- **2026-05-21 — T7 (Tier 1):** Heat dose 1 session in last 14 days (last: 10 May hot bath 25 min @ 45°C) vs target ≥3. Day 7 of travel block — no bath access until Marseille. First realistic window: Mon 24 May; target 4–5 sessions across 24–29 May to begin rebuilding protocol.
- **2026-05-21 — T8 (Tier 2):** Last heat session 2026-05-10 — now 11 days ago. Adaptation fully lapsed. Marseille 24–30 May is the only rebuild window before the next travel gap; confirm hotel has bath or sauna before departure Sat 23 May.
- **2026-05-21 — T9 (Tier 2):** Dorney Olympic tri entry (C- race 6 Jun) due 2026-05-25 (Mon, 4 days), status TBC. Final day to act — cannot slip past Mon 25 May. Ankle still at 2/10 during runs; quality sessions not cleared; plan Z2 pace for 10k leg if entered.
- **2026-05-22 — T3 (Tier 1):** HRV trend -15.9% over 7 days (44 on 05-15 → 37 on 05-21). Decline deepened vs yesterday's -7.3% as reference window shifted. Multi-signal: RHR 56 (vs 50–54 baseline), illness confirmed 05-21, sleep 6.23h on 05-21. Monitor; avoid any hard sessions until HRV recovers >40.
...
- **2026-05-26 — T7 UPDATE:** Previous entry said "0 sessions in last 14 days" — corrected: heat-log now shows 1 session in last 14 days (05-25 Marseille outdoor ride 110 min @ avg 25°C, 21–29°C range, TSS 88). Still below target ≥3; T7 trigger stands. T8 cleared — last session 05-25 = 1 day ago, within 7-day window.
...
- **2026-05-31 — T3 (Tier 1):** HRV trend −13.2% over 7 days (38 on 05-25 → 33 on 05-30). Today's HRV not yet synced. Multi-signal corroboration: RHR 57 (above 50–54 baseline), sleep 6.1h on 05-30 (<7h target). Session today is Z2-only long ride — cleared for execution. Monitor tomorrow's HRV; if <35 with continued elevated RHR, consider rest or swim substitution.
...
- **2026-06-04 — T9 (Tier 2):** ISM saddle order due 2026-06-06 (Sat, 2 days), status pending — must order today. FTP retest extended due date = 2026-06-04 (today), status pending — schedule or note as missed. PH sweat-sodium test due 2026-05-31, status pending — still no booking made. TT bike fit due 2026-05-31, status pending — still no booking made. Four overdue/imminent actions.
- **2026-06-04 — T10 (Tier 2):** Run km +20.3% w/w — this week (Mon–Thu) 8.34 km (06-03 run only) vs last week 6.93 km (05-27 Marseille walk-run only). 10% cap still applies while ankle in rehab; week is not complete, additional runs Sat/Sun could push further. Monitor ankle response to 06-03 run before prescribing weekend session.
- **2026-06-04 — T3 (Tier 1):** HRV trend −11.4% over 7 days (44 on 05-28 → 39 on 06-03; today 06-04 not yet synced). Trend is recovering from 05-30/05-31 lows (33); 06-03 reading 39 is improving. RHR 52 (within baseline). No multi-signal convergence — HRV alone, no sleep/RHR corroboration. Hold quality sessions until HRV consistently >40.
- **2026-06-04 — T6 (Tier 1, carryover):** Aerobic decoupling >5% on all 3 Z2 rides in last 7-day window: 05-28 (17.7%, IF 0.747, surged hilly session), 05-29 (8.11%, IF 0.721, outdoor heat), 05-31 (7.93%, IF 0.693, avg 25.7°C hot and windy). No new Z2 rides since 05-31. Diagnostic: next Z2 ride in cool conditions (<22°C) — if decoupling still >5%, flag aerobic durability gap.
...
- **2026-06-05 GO** — Long Z2 ride 4 hr (bike_z2): no rules fired, execute as planned. CTL 75.2 (Fitness), ATL 63.8 (Fatigue), TSB +11.4 (Form) — fresh. HRV null (not synced); sleep null (not synced); last RPE 8 (swim 04 Jun). No modulation rules triggered. Session: TT position, NP 174–237W (55–75% FTP), HR 133–146, cadence 85–95 rpm, VI <1.08, ~165 TSS. Nutrition: 80g CHO/hr from 30 min.

- **2026-06-07 GO** — Z2 ride 4 hr (bike_z2): no rules fired, execute as planned. CTL 77.3 (Fitness), ATL 74.2 (Fatigue), TSB +3.1 (Form) — slightly fresh. HRV null (not synced today); sleep null (not synced). Last RPE 8 (swim 04 Jun). FTP note: session description references 316W — use current eFTP 297W; correct Z2 NP range is 163–223W (55–75%). Ankle not relevant for bike.

- **2026-06-06 GO** — Z2 Walk-Run 60 min + Bike Z2 90 min: no rules fired, both sessions execute as planned. CTL 76.7 (Fitness), ATL 71.4 (Fatigue), TSB +5.3 (Form) — fresh. HRV null (not synced today); yesterday HRV 46 (upward trend over 7 days); sleep 2026-06-05 excellent 7.7h / score 95. Run: walk-run 5:30 × 11 reps, HR cap 150, pace 4:50–5:05/km, ankle stop-if->2/10 in force — last logged 1/10 during, 0/10 next morning after 06-03 run. T10 flag active: current week 8.34 km vs last week 6.93 km (+20.3% vs 10% cap); today's ~11 km would push to ~20 km this week — embedded check in session description. Bike: NP 174–237W; note FTP discrepancy — plan uses 316W, current eFTP 297W, so upper bound 237W = 80% not 75%; cap at 223W (75% of 297W) for strict Z2.
...
- **2026-06-07 — T6 (Tier 1, carryover — Telegram suppressed):** 06-05 "Wandsworth Road Cycling" decoupling 15.64% (IF 0.645, VI 1.36, 202 min, avg 18.8°C) still in 7-day window. T6 fired 2026-06-06 for same ride — Telegram suppressed per suppression rule (fired <3 days ago, same activity date). 05-31 "Hot and windy" (IF 0.737, 7.93%) also at 7-day boundary but previously flagged and notified 2026-06-01; treated as carryover. Diagnostic: today's planned 3h50m Z2 ride (Sun 07 Jun) is the next decoupling check.
- **2026-06-07 — T9 (Tier 2):** 2 actions overdue (due 2026-05-31, status pending): (1) Book Precision Hydration sweat-sodium test — 7 days overdue, no booking made. (2) TT bike fit appointment — 7 days overdue, no booking made. Telegram sent.
- **2026-06-07 — T10 (Tier 2):** Run km +160% w/w — this week (Mon 01–Sun 07 Jun) 17.91 km (Wed 03 Jun 8.34 km + Sat 06 Jun 9.57 km) vs last week (Mon 25–Sun 31 May) 6.9 km. 10% cap applies while ankle in rehab (quality_sessions_resumed = false). Week complete (today Sun). Next week cap: ≤19.7 km.
...
- **2026-06-11 — T3 (Tier 1):** HRV trend −16.3% over 7 days (43 on 06-04 → 36 on 06-10). Trajectory since last T3 (06-04): recovered to 46 on 06-05 and 06-07, dipped post-big-ride to 40 on 06-08, recovered to 45 on 06-09, dropped to 36 on 06-10 (day after back-to-back 10.17 + 10.76 km runs). Single-signal only: RHR 53 on 06-10 (within 50–56 baseline) and sleep 7.25h on 06-10 (above 7h threshold) provide no corroboration. No load-reduction action warranted without multi-signal convergence. Monitor HRV 06-12; if recovers >40, downgrade to informational. Today is CSS swim — no intensity flag applies.
- **2026-06-11 — T10 (Tier 2):** Run km +16.9% w/w — current week (Mon 09 Jun–Thu 11 Jun) 20.93 km (Mon 09 Jun 10.17 km + Tue 10 Jun 10.76 km) vs last complete week (Mon 02–Sun 08 Jun) 17.91 km. 10% cap applies while ankle in rehab (quality_sessions_resumed = false); cap = 17.91 × 1.10 = 19.7 km. Already 1.23 km over cap with 2 days' sessions only. Sat 13 Jun run was deleted in Replan 3 — no further run sessions planned this week; week total should hold at 20.93 km. Monitor ankle 06-10 next-morning pain before any additional prescription.
- **2026-06-11 — T11 (Tier 2):** Strength compliance — 0 sessions in Mon 02–Sun 08 Jun (last completed week) and 0 sessions in Mon 26 May–Sun 01 Jun (week before). Target: 2/week. Only strength logged recently: 2026-06-10 ankle stability + mobility (current week, counts toward week of 09–15 Jun). Schedule 2 strength sessions in this current week or next (Tier C — bodyweight, ankle stability, no equipment needed).

- **2026-06-12 — T7 (Tier 2):** Heat maintenance dose 1.0 in last 14 days (only entry in window: 05-31 outdoor ride 182 min @ avg 25.7°C; 05-28 and earlier sessions have now exited the 14-day window). Target ≥2.0. Formal protocol is PAUSED on ambient exposure until 2026-08-22 — ambient is not covering the maintenance dose. Add a sauna or hot-bath session, or plan hot-venue training time. Note: today's 06-12 session description already prescribes a 20 min hot bath post-long-ride — if completed, dose reaches 2.0 tonight.
...
- **2026-06-18 — T7 (Tier 2):** Heat maintenance dose 0.0 in last 14 days (window Jun 4–Jun 18; all heat-log entries are May 31 and earlier, outside window). Formal protocol PAUSED on ambient exposure until 2026-08-22 — ambient not covering maintenance dose. France training camp Jun 24–29 (6 days away) is the next natural heat window; plan outdoor sessions in heat during camp. Add a sauna or hot-bath session before Jun 24 if possible. Last T7 logged Jun 14 (4 days ago — nag suppression lapsed).

- **2026-06-18 — T9 (Tier 2):** Two open actions remain overdue with France camp starting in 6 days (Jun 24): (1) Book Precision Hydration sweat-sodium test — due 2026-05-31, now 18 days overdue, status pending. (2) TT bike fit appointment — due 2026-05-31, now 18 days overdue, status pending. France camp Jun 24–Jul 17 (with gap) = 2 back-to-back camps; last realistic pre-camp booking window is this week. Last T9 logged Jun 14 (4 days ago — nag suppression lapsed).

- **2026-06-20 — T6 (Tier 1):** Aerobic decoupling 5.10% on 2026-06-19 "Friday morning rituals" long Z2 ride (IF 0.727, NP 216W, 255 min, avg HR 141, avg temp 24.1°C, 20–30°C range). Marginally above 5% cap. Context: warm conditions, 4h15m ride, IF at Z2 ceiling, 27% over planned TSS. Comparators: Jun 13 East Hampshire (IF 0.66, decoupling −6.8% — clean; HR fell relative to power) and Jun 14 Wandsworth (IF 0.68, decoupling 3.9% — clear). Marginal breach in warm conditions — likely heat/fatigue-driven rather than structural durability failure. France camp Jun 24–29 will be next diagnostic window; if >5% persists in structured Z2 rides, flag aerobic durability gap requiring investigation.

- **2026-06-21 — T2 (Tier 2):** CTL ramp 4.02/wk today (CTL 88.94 on Jun 21 vs CTL 84.92 on Jun 14 = +4.02/wk) while ankle quality_sessions_resumed = false. Cap is +4/wk in rehab. Marginal breach after 4 days below cap (Jun 17–20 all <4/wk: 3.35, 3.95, 3.55, 2.41). Today's 192 TSS (ride + run) pushes ramp just above the threshold. France camp Jun 24–29 will spike ramp further — hold Z2-dominated structure in camp rather than chasing extra volume day-to-day.

- **2026-06-21 — T7 (Tier 2):** Heat maintenance dose 0.0 in last 14 days (window Jun 7–Jun 21; all heat-log entries are May 31 or earlier, outside window). Target ≥2.0. Formal protocol PAUSED on ambient exposure until 2026-08-22 — ambient is not covering the maintenance dose. France camp starts Jun 24 (3 days); outdoor training in France heat will begin counting dose. Today is last realistic home window for a sauna/hot-bath before departure.

- **2026-06-21 — T9 (Tier 2):** France camp starts Jun 24 (3 days away) — last home window to act on overdue bookings. Two open actions remain pending: (1) Book Precision Hydration sweat-sodium test — due 2026-05-31, now 21 days overdue, status pending. (2) TT bike fit appointment — due 2026-05-31, now 21 days overdue, status pending. Both must be booked today or tomorrow before departure; next realistic UK window after France is Jul 2–9 (98 days to race).

- **2026-06-22 — T3 (Tier 1):** HRV trend −23.9% over 7 days (46 on 06-15 → 35 on 06-21; 06-22 not yet synced). Deepened from Jun 15 entry (−13.0%). Corroborating signals: T4 co-fires today (3 of last 7 nights below 7h); RHR elevated to 55–56 on Jun 21–22 (above 50–54 baseline). Multi-signal convergence: HRV + sleep + elevated RHR. France camp starts Jun 24 — monitor HRV and RHR on arrival; hold intensity sessions in camp until HRV recovers >40.

- **2026-06-22 — T4 (Tier 1):** Sleep <7h on 3 of last 7 nights: 18 Jun 6.45h, 19 Jun 6.05h, 21 Jun 6.63h. Corroborating signal: T3 co-fires today (HRV −23.9%). Heavy load week (Fri 19 Jun 216 TSS long ride; Sun 21 Jun 151 TSS ride+run) likely driving sleep disruption. Pre-camp: prioritise sleep Mon 22 Jun and in-camp; do not set alarms in France if training schedule allows.

- **2026-06-22 — T11 (Tier 2):** Strength compliance — 1 session in each of the last 2 completed weeks (Mon 16–Sun 21 Jun: 1 session Wed 17 Jun; Mon 09–Sun 15 Jun: 1 session Wed 10 Jun) vs target 2/week. Both weeks below target. France camp Jun 24–29 is the next window — schedule 2 strength sessions in camp (Tier C: bodyweight, ankle stability, no equipment needed). Signal changed from Jun 15 entry (was 0+0, now 1+1).

- **2026-06-23 — T9 (Tier 2):** Aero helmet due 2026-06-30 (today+7) — status pending, not previously flagged. Newly enters 7-day decision horizon. France camp departs tomorrow (Jun 24); last UK window to order today. Other overdue T9 items (PH sweat test, TT bike fit) suppressed — same signal logged Jun 21 (2 days ago).

- **2026-06-25 — T4 (Tier 1):** Sleep <7h on 3 of last 7 nights: 19 Jun 6.05h, 21 Jun 6.63h, 24 Jun 5.05h. Prior T4 (Jun 22) flagged Jun 18/19/21 — Jun 24's 5.05h (France camp day 1, Grimaud) is a new night not in that entry; signal materially changed. No T3 co-fire (HRV trend −2.4% over 7 days, single signal, no multi-signal convergence). Context: short camp night expected with travel/day 1 fatigue. Prioritise sleep Thu 25 Jun night.
...
- **2026-07-03 — T4 (Tier 1):** Sleep <7h on 3 of last 7 nights: 27 Jun 6.58h, 30 Jun 5.54h, 2 Jul 6.57h. Prior T4 (Jul 1) flagged 24/27/30 Jun — 2 Jul's 6.57h is a new night not in that entry; signal materially changed. HRV recovered to 45 on 2 Jul (trend +11.9% over 7 days per today's off-plan GO note) — no T3 co-fire. RHR 50 on 2 Jul (within 50–54 baseline) — no corroboration. Single-signal T4 only; today's Long Z2 Ride 330 min already flagged GO with no rules fired. Prioritise sleep this week; re-evaluate if the deficit deepens or a second signal joins it.

- **2026-07-03 — T9 (Tier 2):** Three overdue open actions — suppression lapsed (PH sweat test + TT bike fit last flagged Jun 29, 4 days ago; Aero helmet last flagged Jun 30, 3 days ago): (1) Book Precision Hydration sweat-sodium test — due 2026-05-31, now 33 days overdue, status pending. (2) TT bike fit appointment — due 2026-05-31, now 33 days overdue, status pending. (3) Aero helmet — due 2026-06-30, now 3 days overdue, status pending. Camp #2 starts Jul 10 (7 days away) — the Jul 2–9 return window is the last UK opportunity to book/order all three before departure.
...
- 2026-06-04: ISM saddle order date pushed back 2 months (to 2026-08-06). No saddle position change.
