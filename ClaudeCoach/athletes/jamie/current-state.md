...
- **Sat 4 Jul — Sweetspot Ride Modified 2×15 (PLANNED, per AM check-in):** 110min, 97 Load. SS blocks 246–264W (83–89% of 297W eFTP), recovery 178–208W, NP target ~218W, VI ~1.03. Downgraded from original 4×15 @91% FTP given TSB −22, Fri's 223-Load ride, RPE 8, and short sleep. Nutrition target 75g/hr (last 4 qualifying rides avg 64g/hr, building to 90g/hr race target). Weight and aero helmet re-asked in this AM check-in — no reply yet. RPE for this ride also not yet given.
- **Nutrition focus shift (Sat 4 Jul):** Bike carb tolerance now proven (90–100g/hr demonstrated, e.g. Fri's ~87g/hr) — no need to grind 90g/hr every ride, just the odd session near target to maintain gut tolerance. Open question is now the RUN: can Jamie get near 60g/hr while running. Sun 5 Jul long run (16.9km/82min) is the test bed — 60g/hr ≈ 80g total over the run (~2 gels + carb drink sips, or a gel every ~25min from the 20min mark). See persistent-rules.md rule 112. Log actual intake + gut response on that run.
- **Sun 5 Jul — Long Run:** corrected to 82min/16.9km/94 Load (event 119142487, was 95min/19.5km/109). Progression basis: last week's actual long run was 15.2km (28 Jun, Grimaud, France), not the stale 13.5km baseline — 15.2×1.10–1.15 = 16.7–17.5km. Also the run-fuelling test bed for the ~60g/hr target (see above).
...
- **Thu 2 Jul — Z2 Ride 105min (COMPLETED):** Not Z2 — NP 224W/IF 0.75. TSS 97 vs 106 (−8%). PR: Firmin roundabout. No heat dose (24.4°C, just under 25°C gate). Nutrition: 80g carb reported for the ride.
