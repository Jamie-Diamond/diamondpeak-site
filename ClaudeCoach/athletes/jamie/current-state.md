...
- **Thu 25 Jun AM — Endurance ride + climbs (COMPLETED):** 151 min · NP 206W · IF 0.69 · 119 TSS. 71% Z1–Z2. ERA5 32–35.5°C. Fuel 216g/86g/hr · ~2.5L.
...
- **Week Mon–Sat: ~595 TSS** (Run 49 + Swim 52 + Run 51 + Ride 119 + OWS 22 + Ride 197 + Ride ~105). Sun 28 Jun plan: long run ~15km (~85 TSS) + short OW swim (~25 TSS) → projected ~705. Above maintenance floor 608.
- **France holiday (not camp) ends 29 Jun.** Do NOT auto-generate next week's plan — wait for Jamie to request it after returning.
- **Strava scripts (updated 26–27 Jun):** wit/humour removed (unprofessional); 401 error guard added; "camp"→"holiday"; last 3 activities re-verified compliant 27 Jun.
