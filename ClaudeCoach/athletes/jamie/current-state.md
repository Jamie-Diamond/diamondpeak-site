...
- **France camp — week 22–28 Jun (Day 2 prescribed):** Schedule: Mon 22 easy run 46 · Tue 23 swim 52 · Wed 24 Z2 run 51 · **Thu 25 Z2 ride 92 (GO — prescribed 25 Jun)** · Fri 26 long ride 183 · Sat 27 Z2 ride 92 · Sun 28 long run + OW swim 120. ~642 TSS floor (heat/consecutive fatigue/OW durability invisible to TSS). Week of 29 Jun CLEAR; build on return.
- **Thu 25 Jun — Z2 ride 2h (PRESCRIBED: GO, no adjustments):** HRV trend −2.6% (latest 41, 24 Jun); sleep 5.05h carried; ATL 91, CTL 86, TSB −5; ankle 3/10 yesterday (bike = no dorsiflexion load). No rules fired. Targets: NP 203W (IF 0.68, Z2 178–223W); HR cap 140; 60g/hr carbs; 700ml/hr fluid.
- **Next: Fri 26 Jun — Long ride ~183 TSS.** Check ankle AM score before prescribing.
- **Wed 24 Jun — France camp Day 1 Z2 run (COMPLETED):** 8.91km, 51 TSS, GAP 5:10/km, avg HR 143 vs 150 ceiling = EASY. ERA5 ambient 30.9–32°C (RH 49%) — 4th 28°C+ heat exposure in 72h. Ankle 3/10 first half, settled 1–2/10 second half — within 5/10 tolerance. Strava updated with ERA5 ambient. Next time: open at 5:15–5:20 GAP to preserve HR ceiling for back half.
- **Tue 23 Jun — Speed/technique swim (last pool before France):** 2,000m, 34:18, 52 TSS. Drill 4×100m WITH paddles (catch/strength focus only — no pace target, rule 78); speed 8×100m paddle-OFF avg 1:38 vs TGT 1:36–1:38 (drifted 1:42 rep 5, rallied 1:36 last 3 — strong finish); 2×200m PB at CSS 1:41/1:40. Rules 78+79 confirmed: paddle reps = catch quality not speed; always identify from session plan which sets used paddles. Next time (paddle-OFF): go out 1:37 reps 1–4 to hold the band throughout.
- **Mon 22 Jun — Easy run (EASY + heat, last home run):** 7.62km, 49 TSS, GAP 4:53/km. Avg HR 141 vs 146 ceiling = EASY. ERA5 ~28°C. Main-block drift 140→147 (~7 bpm, WU/CD clipped per rule 74). Strava updated.
- **Sun 21 Jun — Endurance ride 187min + Long run 70min** (big training day pre-France).
- **Ankle:** ATFL + CFL partial tear (ultrasound confirmed 2026-06-12). Latest: 3/10 peak during France Day 1 run (24 Jun), settled 1–2/10 second half — highest during-run score since clearance; heat + new terrain likely cause. Need 25 Jun AM score to confirm settled overnight. Protocol: ≤5/10 during = OK if resolves by next AM; >5/10 = stop.
- **Heat log:** 4 sessions ≥28°C in 72h into camp (Sat ride 28°C · Sat brick 31°C · Mon run 28°C · Wed run 31°C). ERA5 ambient confirmed for all — watch temp triggers now covered by rules 75/76/80.
- **CP vs FTP (confirmed 24 Jun):** eFTP 297W = working metric for IM (race IF 0.68–0.73); CP+W′ populated passively from power curve; no structured CP or FTP test recommended (rule 12 unchanged).
- **Weight:** ~83 kg; race target 79 kg (19 Sep 2026); ~4 kg to lose.
- **CTL/form (25 Jun):** CTL 86, ATL 91, TSB −5. HRV trend −2.6% (latest 41 on 24 Jun; today not synced at 05:00 — trailing trend). Sleep 5.05h carried (24 Jun). Build week 9. IM Italy Emilia-Romagna 19 Sep 2026 (~86 days).
- **Bug list (24 Jun — 11 open):** (1) Cervélo hallucination; (2) Planning algo copies ICU calendar; (3) TSS flat-rate estimation; (4) Morning cron duplicate; (5) Replan-week button too easy; (6) NOT EASY on terrain-Z3 run (→rule 77); (7) WU/CD drift clipping (→rule 74); (8) Bug list not maintained (meta-bug, logged 24 Jun); (9) ERA5 when watch ≥25°C (→rule 75); (10) Ambient start/mid/end long sessions (→rule 76); (11) Voice reply button feature. Code fixes for 5, 8, 11 still pending; 6–10 corrected as rules.
- **Open actions (overdue):** Precision Hydration sweat-sodium test · TT bike fit · Running FTP 500W in Intervals.icu.
