...
- **Fri 26 Jun — double session (completed)**: (1) Grimaud Cycling: 2hr22min, 52km, 882m, avg 148/max 182bpm, 82% Z1-Z2 HR, ~113 Load, no power meter, 32–38°C. Nutrition not logged — still chasing. (2) Grimaud Running (brick): 6.01km, GAP 5:26/km, avg 182/max 197bpm, Load 47, 89% Z3+ HR; drift 167→191bpm (heat + brick fatigue, expected). RPE not logged.
...
- **Travel block Jun 22–28**: Ends Sun 28. Remaining: Sat 27 + Sun 28 long run 90min.
