...
- **Sat 27 Jun (today)**: Morning check-in sent; weight not logged. Bike Z2 2hr (114–133W, HR cap 170, 55g/hr). No brick — brought forward to Fri 26. Form −20 (Heavy). Luteal day 18 + heat: hold Z2 loosely.
- **Fri 26 Jun — double (completed)**: (1) Grimaud Cycling: 2hr22min, 52km, 882m, avg 148/max 182bpm, 82% Z1-Z2 HR, ~113 Load, 32–38°C. Nutrition logged: white choc macadamia clif bar + honey gel + 8 haribo + 700ml water + 600ml electrolyte (~33g/hr). (2) Brick Run (Grimaud): 6.01km, GAP 5:26/km, avg 182/max 197bpm, Load 47, 89% Z3+ HR; drift 167→191bpm (heat + brick fatigue). RPE not logged.
...
- **Tue 23 Jun** — Sweetspot 3×15 (90min cap). NP 162W (83% FTP), IF 0.83, 92 TSS. RPE 6. ICU had wrong session; confirmed custom plan took precedence.
- **Mon 22 Jun** — Kettlebells 45min · 28 TSS · RPE 7.
- **Fuelling gap (persistent)**: Recent avg ~33g/hr; race target 70g/hr. Fri 26 ride fully logged (~33g/hr + 700ml water + 600ml electrolyte). Thu 25 ~21g/hr. Nudge every long session.
...
- **Travel block Jun 22–28**: Final day today (Sat 27). Remaining: Sun 28 long run 90min.
- **Sleep**: Persistent disruption — 4+ nights <7h in travel week (Jun 18, 19, 21, 24=5.2h). HRV recovering (Jun 23=65, Jun 24=67). Monitor closely entering build w/c 29 Jun.
- **Fitness**: CTL 60.5, Form −20 (Heavy). Base target met; build phase begins Mon 29 Jun.
- **Weight**: Not recently logged.
- **Open**: Sea swim Thu 25 unconfirmed; Fri 26 brick RPE not logged.
