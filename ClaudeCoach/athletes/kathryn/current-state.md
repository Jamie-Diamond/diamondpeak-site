...
- **Wed 24 Jun (today)** — Rest day (travel block day 3, luteal day 15). Sleep 5.2h (concern). HRV Jun 23=65, Jun 24=67 — best in 2+ weeks, recovering. ATL 59, CTL 56, Form −3.
- **Tue 23 Jun** — Sweetspot 3×15 outside (Kathryn capped ride at 90min). NP 162W (83% FTP), IF 0.83, HR 153avg/181max, 92 TSS, RPE 6. ICU had wrong session — plan corrected to Sweetspot 3×15.
- **Mon 22 Jun** — Kettlebells 45min · 28 TSS · RPE 7 · travel block day 1. Wk 8 plan confirmed ("Yes").
...
- **Base wk 7 summary (15–21 Jun)**: 428/~482 TSS, Fitness 57.8, Form −12 — slightly under target, fitness rising; 428 TSS confirmed above maintenance.
- **Base wk 8 plan confirmed (~479 TSS)**: KB Mon ✓ · Sweetspot 3×15 Tue ✓ · Rest Wed ✓ · Sea swim ~40min + easy run 45min Thu · Bike Z2 2hr Fri · Bike Z2 2.5hr + brick Sat · Long run 90min easy Sun — 6 wrong auto-synced sessions cleared.
- **RPE scale explained this session**: Kathryn was unfamiliar — briefed 1–2=recovery, 3–4=Z2, 5–6=sweetspot/tempo, 7–8=threshold, 9=VO2, 10=max.
- **Fuelling gap (persistent)**: ~33g/hr on long rides vs 70g/hr race target — nudge on every long session.
- **Menstrual phase**: luteal started 24 Jun, runs ~24 Jun–7 Jul; RPE-led, higher core temp; 25–35°C travel-heat stacks through rest of travel block.
- **Travel block Jun 22–28 active**: sea swim Thu–Sun (open-water aerobic, no CSS targets); no cycle Sunday; no time cap Thu–Sat.
- **Sleep concern**: patchy sleep (5.2h Jun 24, multiple nights <7h Jun 16–24) — monitor closely through luteal + heat.
- **Build phase starts w/c 29 Jun** — Base wk 8 is final base week; always use ICU live engine for phase/week numbering (static calendar was off by one week).
- **Open**: fuelling gap to nudge each long session; next long ride needs uninterrupted route (river path); sleep monitoring ongoing.
