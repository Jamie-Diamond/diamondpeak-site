...
- **Sat 27 Jun (today)**: Bike Z2 2hr planned (114–133W, HR cap 170, 55g/hr). No brick — Kathryn brought brick forward to Fri 26 (done). Travel block final day. Form −20 (Heavy). Luteal day 18 + heat.
- **Fri 26 Jun — double (completed)**: (1) Grimaud Cycling: 2hr22min, 52km, 882m, avg 148/max 182bpm, 82% Z1–Z2 HR, Load 113, 32–38°C. Nutrition: white choc macadamia Clif bar + hilltop honey gel + 8 Haribo + 700ml water + 600ml electrolyte (~33g/hr). (2) Brick Run: 6.01km, GAP 5:26/km, avg 182/max 197bpm, Load 47, 89% Z3+ HR; HR drift 167→191bpm (heat + brick fatigue). RPE not provided.
...
- **Tue 23 Jun**: Sweetspot 3×15 outside: NP 162W (83% FTP), IF 0.83, 92 TSS, RPE 6. Kathryn corrected plan mid-session (ICU showed Z2 2hr; she did 3×15 sweetspot).
...
- **Week load**: 602 Load vs 536 target (+12%) — heat inflating every ride across the travel block; not overreach.
- **Menstrual phase**: Luteal day 18 (24 Jun–7 Jul). Higher RPE, higher core temp; stacks with heat through build w/c 29 Jun.
...
- **Open**: Fri 26 brick RPE not provided; Sun 28 long run 90min to complete.
