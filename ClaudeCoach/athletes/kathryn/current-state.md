...
- **Wed 24 Jun (today)** — Rest day (travel block day 3, luteal day 15). Sleep 5.2h (concern — patchy sleep throughout travel block). HRV Jun 23=65, Jun 24=67 — best in 2+ weeks, T3 recovering toward clear. ATL 59, CTL 56, Form −3.
- **Tue 23 Jun** — Sweetspot 3×15 outside (Kathryn capped at 90min). NP 162W (83% FTP), IF 0.83, HR 153avg/181max, 92 TSS, RPE 6. ICU had wrong session (Bike Z2 2hr) — confirmed plan corrected to Sweetspot 3×15 in calendar.
- **Mon 22 Jun** — Kettlebells 45min · 28 TSS · RPE 7 · travel block day 1. Kathryn explicitly confirmed the wk 8 plan ("Yes").
...
- **Base wk 8 plan confirmed (~479 TSS)**: KB Mon ✓ · Sweetspot 3×15 Tue ✓ · Rest Wed ✓ · Sea swim ~40min + easy run 45min Thu · Bike Z2 2hr Fri · Bike Z2 2.5hr + brick Sat · Long run 90min easy Sun — pushed to Garmin; 6 wrong auto-synced sessions cleared.
...
- **Travel block Jun 22–28 active**: sea swim Thu–Sun (open-water aerobic, no CSS targets); no cycle Sunday; no time cap Thu–Sat; outside bike Tue ✓.
- **Sleep concern**: patchy sleep across travel block (5.2h Jun 24, multiple nights <7h Jun 16–24) — monitor closely through luteal phase in heat.
